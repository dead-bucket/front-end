...
class SendPasswordReset extends Component {
  ...
  render() {
    ...
    if (this.props.type === "password") {
      successMessage = (
        <div className={this.props.classes.resetMessages}>
          A reset email has been sent to: {this.state.email}, you will be
          redirected soon. If you are not automatically redirected click here{" "}
          <a href="/">login</a>
        </div>
      );
    } else {
      successMessage = (
        <div className={this.props.classes.resetMessages}>
          A email has been sent to: {this.state.email}, with your username. You
          will be redirected soon. If you are not automatically redirected click
          here <a href="/">login</a>
        </div>
      );
    }
    if (this.state.errorMessage) {
      errorMessage = (
        <div className={this.props.classes.resetMessages}>
          {this.state.email}, is not registered on Thoughtline. Please enter a
          valid address.
        </div>
      );
    }
